    ...
    <div>
      ...
      <section style={{ backgroundColor: "#EDE9E1", borderBottom: "1px solid #D4C9B0" }}>
        <div className="max-w-7xl mx-auto px-6 md:px-10 py-12">
          <p className="text-[10px] uppercase tracking-[0.2em] mb-2" style={{ color: "#8A8680" }}>Our Collection</p>
          <h1 className="font-display" style={{ fontFamily: "var(--font-dm-serif), Georgia, serif", fontSize: "clamp(2rem,4vw,3rem)", color: "#1C1C1A" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-8">
          ...
          <div className="flex items-center gap-3">
            <div className="relative flex-1 max-w-sm">
              ...
              <input
                ...
                style={{ border: "1px solid #D4C9B0", backgroundColor: "#FDFAF6", color: "#1C1C1A" }}
              />
            </div>
            {(search || categoryId) && (
        ...
        {loading ? (
          ...
          <div className="py-24 text-center">
            ...
            <p className="font-display text-xl mb-2" style={{ fontFamily: "var(--font-dm-serif), Georgia, serif" }}>Nothing found</p>
